...
/**
 * Implements a fee that applies a rate to a principal.
 *
...
{
    public function __construct(protected readonly PrincipalInterface $principal, protected readonly string $rate)
    {
    }

    public function compute($record): Amount
    {
        $principal = $this->principal->getAmount($record);
